...
//
namespace Steigauf.MVVM.Adorner
{
    //
    ...
    public class FrameworkElementAdorner : System.Windows.Documents.Adorner
    {
            ...
            : base(adornedElement)
        {
            ...
            //Habe ich hinzugefügt, um den Event zu erhalten wenn die Sichtbarkeit der Adorned Control sich ändert
        ...
        /// <summary>
        /// Ereignis welches ausgelöst wird, wenn die Sichtbarkeit der Adorned Control
        /// sich geändert hat
        /// </summary>
        private void adornedElement_IsVisibleChanged(object sender, DependencyPropertyChangedEventArgs e)
        {
